            ...
            function renderCart(cart) {
                ...
                for (const [name, item] of Object.entries(cart)) {
                    ...
                    li.innerHTML = `
                        ...
                        <button class="btn" onclick="removeFromCart('${name}')">Удалить</button>
                    `;
        ...
        <div class="store-container">
            <?php foreach ($items as $component): ?>
                <div class="shelf">
                    ...
                    <button class="btn" onclick="addToCart('<?php echo htmlspecialchars($component['name']); ?>', '<?php echo htmlspecialchars($component['price']); ?>')">Добавить в корзину</button>
                </div>
            <?php endforeach; ?>
        </div>
    <?php endforeach; ?>
